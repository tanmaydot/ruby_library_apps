...
ActiveRecord::Schema.define(version: 2023_10_26_102728) do
  ...
  create_table "book_allotments", force: :cascade do |t|
  ...
  add_foreign_key "book_allotments", "admin_users"
  add_foreign_key "book_allotments", "books"
  add_foreign_key "books", "sections"
  add_foreign_key "books", "shelves"
  add_foreign_key "shelves", "sections"
  add_foreign_key "transactions", "admin_users"
